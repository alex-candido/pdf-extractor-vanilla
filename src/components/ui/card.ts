class Card extends HTMLElement {
  constructor() {
    ...
    description.innerHTML = this.getAttribute("data-description") as string
    ...
    if (this.hasAttribute("data-image")) {
      ...
      image.src = this.getAttribute("data-image") as string
      if (this.hasAttribute("data-image-alt")) {
        image.alt = this.getAttribute("data-image-alt") as string
      }
    ...
    if (this.hasAttribute('data-cta-href')) {
      ...
      cta.href = this.getAttribute("data-cta-href") as string;
    ...
    if (typeof ctaContainer !== 'undefined') {
